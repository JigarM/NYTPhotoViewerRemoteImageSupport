...
- (instancetype)initWithPhotos:(NSArray *)photos initialPhoto:(NYTPhoto *)initialPhoto {
    return [self initWithPhotos:photos initialPhoto:initialPhoto delegate:nil];
}

-(instancetype)initWithPhotos:(NSArray<NYTPhoto *> * _Nonnull)photos initialPhoto:(NYTPhoto * _Nonnull)initialPhoto withMaximumZoomScale:(CGFloat)maximumZoomScale{
    self.maxZoomScale = maximumZoomScale;
    return [self initWithPhotos:photos initialPhoto:initialPhoto delegate:nil];
}

- (instancetype)initWithPhotos:(NSArray *)photos initialPhoto:(NYTPhoto *)initialPhoto delegate:(id<NYTPhotosViewControllerDelegate>)delegate {
...
- (void)commonInitWithPhotos:(NSArray *)photos initialPhoto:(NYTPhoto *)initialPhoto delegate:(id<NYTPhotosViewControllerDelegate>)delegate {
...
- (void)setupPageViewControllerWithInitialPhoto:(NYTPhoto *)initialPhoto {
...
- (void)didSingleTapWithGestureRecognizer:(UITapGestureRecognizer *)tapGestureRecognizer {
   [self setOverlayViewHidden:!self.overlayView.hidden animated:YES];
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(photosViewController:handleTapForPhoto:withGestureRecognizer:)]) {
        [self.delegate photosViewController:self handleTapForPhoto:self.currentlyDisplayedPhoto withGestureRecognizer:tapGestureRecognizer];
    }
}
...
- (NYTPhotoViewController *)newPhotoViewControllerForPhoto:(NYTPhoto *)photo {
    if (photo) {
        UIView *loadingView;
        ...
        CGFloat maximumZoomScale = self.maxZoomScale;
        photoViewController.scalingImageView.maximumZoomScale = maximumZoomScale;
...
- (void)didNavigateToPhoto:(NYTPhoto *)photo {
...
- (NYTPhoto *)currentlyDisplayedPhoto {
