 ...
 */
@property (nonatomic, readonly, nullable) NYTPhoto *currentlyDisplayedPhoto;
 ...
 */
- (instancetype)initWithPhotos:(NSArray<NYTPhoto*> *)photos;
 ...
 *  @return A fully initialized object.
 */
- (instancetype)initWithPhotos:(NSArray<NYTPhoto*> *)photos initialPhoto:(NYTPhoto *)initialPhoto;
 ...
 *  @return A fully initialized object.
 */
-(instancetype)initWithPhotos:(NSArray<NYTPhoto *> *)photos initialPhoto:(NYTPhoto *)initialPhoto withMaximumZoomScale:(CGFloat)maximumZoomScale;
/**
 ...
 *  @return A fully initialized object.
 */
- (instancetype)initWithPhotos:(NSArray<NYTPhoto*> *)photos initialPhoto:(NYTPhoto *)initialPhoto delegate:(nullable id <NYTPhotosViewControllerDelegate>)delegate NS_DESIGNATED_INITIALIZER;
 ...
 */
- (void)displayPhoto:(NYTPhoto *)photo animated:(BOOL)animated;
 ...
 */
- (void)appendImages:(NSArray <NYTPhoto *> *)photos;
 ...
 */
- (UIView * _Nullable)photosViewController:(NYTPhotosViewController *)photosViewController captionViewForPhoto:(NYTPhoto *)photo;
 ...
 */
- (NSString * _Nullable)photosViewController:(NYTPhotosViewController *)photosViewController titleForPhoto:(NYTPhoto *)photo atIndex:(NSUInteger)photoIndex totalPhotoCount:(NSUInteger)totalPhotoCount;
 ...
 */
- (UIView * _Nullable)photosViewController:(NYTPhotosViewController *)photosViewController loadingViewForPhoto:(NYTPhoto *)photo;
 ...
 */
- (UIView * _Nullable)photosViewController:(NYTPhotosViewController *)photosViewController referenceViewForPhoto:(NYTPhoto *)photo;
 ...
 */
- (BOOL)photosViewController:(NYTPhotosViewController *)photosViewController handleLongPressForPhoto:(NYTPhoto *)photo withGestureRecognizer:(UILongPressGestureRecognizer *)longPressGestureRecognizer;

/**
 *  Called when a photo is tap once.
 *
 *  @param photosViewController       The `NYTPhotosViewController` instance that sent the delegate message.
 ...
 */
- (BOOL)photosViewController:(NYTPhotosViewController *)photosViewController handleActionButtonTappedForPhoto:(NYTPhoto *)photo;
